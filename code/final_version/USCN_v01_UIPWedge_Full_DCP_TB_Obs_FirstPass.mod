...
// Fully Dynare-compatible, linear, ready for Bayesian estimation
// DCP channel linearized (lambda_CN replaced by lambda_ss)
// =====================================================
...
model(linear);
  ...
  pi_CN_CPI =
    ...
    + chi_dcp*lambda_ss*de;   // <- linearized DCP channel
...
shocks;
  ...
  var eps_mu;    stderr 0.1;
  var xi_lambda; stderr 0.05;
end;
